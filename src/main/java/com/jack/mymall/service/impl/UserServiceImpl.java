...
import com.jack.mymall.common.TokenCache;
import com.jack.mymall.dao.UserMapper;
import com.jack.mymall.pojo.User;
import com.jack.mymall.service.IUserService;
import com.jack.mymall.util.MD5Util;
...
public class UserServiceImpl implements IUserService {
    ...
    public ServerResponse<String> register(User user) {
        ...
        if (resultCount>0){
            ServerResponse.createByErrorMessage("用户名存在");
        }
    ...
    public ServerResponse<String> checkValid(String str,String type){
        if (StringUtils.isNotBlank(type)){
            if (Const.USERNAME.equals(type)){
                ...
                if (resultCount>0){
                    System.out.println("进入checkValid 的checkeUsername");
    ...
    public ServerResponse<String> resetPassword(String passwordOld,String passwordNew,User user){
        ...
        int resuletCount = userMapper.checkPassword(MD5Util.MD5EncodeUtf8(passwordOld), user.getId());
        if (resuletCount==0){
